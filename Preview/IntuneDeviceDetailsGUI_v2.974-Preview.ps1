<#
.Synopsis
   Intune Device Details GUI ver 2.974 - Preview
   
   Preview version is development version with new features
   which I personally use daily in my own work.
   ...
   https://github.com/petripaavola/IntuneDeviceDetailsGUI/tree/main/Preview
.DESCRIPTION
...
$ScriptVersion = "ver 2.974 Preview"
$IntuneDeviceId = $id
